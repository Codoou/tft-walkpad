    ...
    with mss.mss() as sct:
        while True:
            ...
            if DEBUG_PREVIEW:
                ...
                cv2.putText(
                    dbg_img,
                    f"STABLE HP: {stable_hp if stable_hp is not None else 'None'}",
                    (10, 28),
                    cv2.FONT_HERSHEY_SIMPLEX,
                    0.8,
                    (0, 255, 0) if stable_hp is not None else (0, 0, 255),
                    2,
                )
                cv2.putText(
                    dbg_img,
                    f"TM: {treadmill.state.speed_kmh:.1f} km/h  {treadmill.state.incline_pct:.1f}%",
                    (10, 58),
                    cv2.FONT_HERSHEY_SIMPLEX,
                    0.7,
                    (255, 255, 255),
                ...
                cv2.putText(
                    dbg_img,
                    f"TARGET: {target_speed:.1f} km/h  {target_incline:.1f}%",
                    (10, 86),
                    cv2.FONT_HERSHEY_SIMPLEX,
                    0.7,
                    (255, 255, 0),
